...
def evaluate_year(test_year, df, review_vectorizer, clf):
    ...
    correct_winner = (
        ...
        and predicted_winner["Film Name"] == actual_winner["Film Name"]
    )
...
def main():
    ...
    review_vectorizer = TfidfVectorizer(
        max_features=1000, stop_words=custom_stop_words, ngram_range=(1, 2)
    )
    ...
    print("\n=== Final Results ===")
    print(
        f"Correctly predicted winners in {correct_winners} of {len(results_df)} years"
    )
